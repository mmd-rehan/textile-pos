...
- Admin: full purchase access.
- Manager: create/approve purchases.
- Inventory Staff: enter rolls and print barcodes.
- Accountant: supplier payments and payable review.
- Cashier/Salesman: no purchase management.

## Sensitive Purchase Actions
